...
contract=driver.find_elements(By.CSS_SELECTOR, 'td:nth-child(6)')
for item4 in contract:
    contractlst.append(item4.text)


club=driver.find_elements(By.CSS_SELECTOR, 'td:nth-child(15)')
for item5 in club:
...
age=driver.find_elements(By.CSS_SELECTOR, 'td:nth-child(13)')
for item8 in age:
    agelst.append(item8.text)

country=driver.find_elements(By.CSS_SELECTOR, 'td:nth-child(14)')
